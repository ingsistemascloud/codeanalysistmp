                        ...
                        <div class="page-header float-left">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active"><a href="#">Eliminar galería</a></li>
                                </ol>
                            </div>
                        </div>    
                    </div>
                        ...
                        <div class="col-md-12">                	
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <strong class="card-title">Eliminar galería</strong>
                                </div>
                                <div class="card-body">
                                    ...
                                    <form:form id="formGaleria" action="borrarGaleria" method="post" modelAttribute="galeria">
                                        ...
                                        <div class="form-group">
                                            <label for="text-input" class=" form-control-label">¿Está seguro de eliminar la galería "${galeria.nombre}"?</label>                                		
                                        </div> 
