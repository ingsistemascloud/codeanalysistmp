                        ...
                        <div class="page-header float-left">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active"><a href="#">Registrar galería</a></li>
                                </ol>
                            </div>
                        </div>    
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title">Registrar galería</strong>
                                </div>
                                <div class="card-body">
                                    ...
                                    <form:form id="formGaleria" action="guardarGaleria" method="post" modelAttribute="galeria" enctype="multipart/form-data">
                                        ...
                                        <button type="button" onclick="guardarGaleria()" style="background: #d34836" class="btn btn-danger">Registrar</button> 
                                    </form:form>                                         
                                </div>
                            </div>
                        </div>
