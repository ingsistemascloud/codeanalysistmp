                        ...
                        <div class="page-header float-left">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active"><a href="#">Eliminar actividad</a></li>
                                </ol>
                            </div>
                        </div>    
                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form:form id="formActividad" action="borrarActividad" method="post" modelAttribute="actividad">
                                        ...
                                        <div class="form-group">
                                            <label for="text-input" class=" form-control-label">¿Está seguro de eliminar la actividad "${actividad.nombre}"?</label>                                		
                                        </div> 
