                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a id="registraractividad" href="${contextPath}/registrarActividad" style="background: #d34836" 
                                       class="btn btn-danger">Registrar actividad</a> <br> <br>
                                    <!-- Tabla con las actividades -->
                                    <table id="bootstrap-data-table"
                                           class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                <th scope="col" style="width: 14%">Fecha de inicio</th>
                                                <th scope="col" style="width: 14%">Fecha de fin</th>
