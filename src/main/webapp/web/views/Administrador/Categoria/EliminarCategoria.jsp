                        ...
                        <div class="page-header float-left">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active"><a href="#">Eliminar categoría</a></li>
                                </ol>
                            </div>
                        </div>    
                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form:form id="formCategoria" action="borrarCategoria" method="post" modelAttribute="categoria">
                                        ...
                                        <div class="form-group">
                                            <label for="text-input" class=" form-control-label">¿Está seguro de eliminar la categoría "${categoria.nombre}"?</label>                                		
                                        </div> 
