                        ...
                        <div class="page-header float-left">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="${contextPath}/categorias">Categorías</a></li>
                                    <li class="active"><a href="#">Registrar categoría</a></li>
                                </ol>
                            </div>
                        </div>    
                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form:form id="formCategoria" action="guardarCategoria" method="post" modelAttribute="categoria">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <form:textarea id="descripcion" name="descripcion" class="form-control" path="descripcion" rows="5" cols="130" required = "true" placeholder="Esta categoría es para ofrecer información acerca de..." /> 
                                        </div>   
