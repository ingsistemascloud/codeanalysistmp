                        ...
                        <div class="page-header float-left">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="${contextPath}/contactos">Contactos</a></li>
                                    <li class="active"><a href="#">Eliminar contacto</a></li>
                                </ol>
                            </div>
                        </div>    
                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form:form id="formContacto" action="borrarContacto" method="post" modelAttribute="contacto">
                                        ...
                                        <div class="form-group">
                                            <label for="text-input" class=" form-control-label">¿Está seguro de eliminar el contacto "${contacto.nombre}"?</label>                                		
                                        </div> 
