                            ...
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li><a href="${contextPath}/indexAdmin">Panel de
                                            control</a></li>
                                    <li class="active"><a href="#">Enlaces de interés</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title">Enlaces de interés</strong>
                                </div>
                                <div class="card-body">
                                    <!-- /Card -->
                                    ...
                                    <a id="registrarenlace" href="${contextPath}/registrarEnlaceDeInteres" style="background: #d34836" 
                                       class="btn btn-danger">Registrar enlace de interés</a> <br> <br>
