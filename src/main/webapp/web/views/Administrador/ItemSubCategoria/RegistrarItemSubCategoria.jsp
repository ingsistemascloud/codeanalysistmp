                        ...
                        <div class="page-header float-left">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active"><a href="#">Registrar ítem de Subcategoria</a></li>
                                </ol>
                            </div>
                        </div>    
                    </div>
                        ...
                        <div class="col-md-12">                	
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <strong class="card-title">Registrar ítem de subcategoria</strong>
                                </div>
                                <div class="card-body">
                                    ...
                                    <!-- Formulario -->
                                    <form:form id="formSubCategoria" action="guardarItemSubCategoria" method="post" modelAttribute="itemsubcategoria">
                                        <!-- Campo para escoger la categoria -->
                                        <div class="form-group">         			
                                            <form:select path="subcategoria.id" id="idSubCategoria" class="form-control">
                                                <form:option value="0" label="Seleccione la subcategoria" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <form:textarea id="descripcion" name="descripcion" class="form-control" path="descripcion" rows="5" cols="130" required = "true" placeholder="Este ítem de subcategoria es para ofrecer información acerca de..." /> 
                                        </div>   
