    ...
    <body>
                        ...
                        <div class="page-header float-left">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active"><a href="#">Registrar contenido</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form:form id="formContenido" action="guardarContenido"	method="post" modelAttribute="contenido">
                                        ...
                                        <div id="titulo" class="form-group">
                                            ...
                                            <form:input id="nombre" path="nombre" class="form-control"	placeholder="Oficina de la universidad lanza su página oficial." aria-invalid="false" required="true" />
                                        </div>
                                        ...
                                        <button id="registrar" type="button" onclick="enviarDatos()" style="background: #d34836" class="btn btn-danger">Registrar</button>
                                    </form:form>
                                </div>
                            </div>
                        </div>
        ...
        <script type="text/javascript">
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function (result) {
                                                        ...
                                                        if (result == 'Registrado') {
                                                            window.location.replace(`${contextPath}/contenidos?resultado=registrado`);						
                                            ...
                                            function cambiarDeTipoDeAsosiacion() {
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function (result) {
                                                        ...
                                                        agregarOpcion(document.getElementById("asosiacion"), 0, "Seleccione la asociación");
                                            ...
                                            function pintarRegistroExitoso() {
                                                ...
                                                var texto = document.createTextNode("Contenido registrado con éxito.");
