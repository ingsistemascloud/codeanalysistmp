                        ...
                        <div class="page-header float-left">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active"><a href="#">Eliminar Contenido</a></li>
                                </ol>
                            </div>
                        </div>    
                    </div>
                        ...
                        <div class="col-md-12">                	
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <strong class="card-title">Eliminar contenido</strong>
                                </div>
                                <div class="card-body">
                                    ...
                                    <form:form id="formContenido" action="borrarContenido" method="post" modelAttribute="contenido">
                                        ...
                                        <div class="form-group">
                                            <label for="text-input" class=" form-control-label">¿Está seguro de eliminar el contenido asociado a ${contenido.tipoAsociacion} llamado "${asociacion}"?</label>                                		
                                        </div> 
