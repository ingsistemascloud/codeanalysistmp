                                ...
                                <div class="card-body">
                                    ...
                                    <form:form id="formCuenta" action="editarCuenta" method="post" modelAttribute="usuario">
                                        ...
                                        <div class="form-group">
                                            <label for="text-input" class=" form-control-label">Digite la contraseña actual</label>
                                        ...
                                        <div class="form-group" style="display: none">
                                            ...
                                            <form:input id="codigoNuevo" path="codigoNuevo" class="form-control" aria-invalid="false" value="${usuario.codigoNuevo}"/>
                                        </div> 
                                        <!-- Campo para digitar el nombre -->
                                        <div class="form-group">
                                        ...
                                        <div class="form-group" style="display: none">
                                            ...
                                            <form:input id="correoCalendario" path="correoCalendario" class="form-control" aria-invalid="false"/>
                                        </div>  
                                        <div class="form-group">
                                            <label>Digite la contraseña nueva</label>                            
                                            <form:password path="contrasenaNueva" class="form-control" placeholder="Minimo 4 números, 4 letra minusculas y 2 mayusculas"/>     
                                        </div>
                                        <div class="form-group">
                                            <label>Digite de nuevo la contraseña nueva</label>                            
                                            <form:password path="contrasenaNueva2" class="form-control" placeholder="Minimo 4 números, 4 letra minusculas y 2 mayusculas"/>     
                                        </div>
                                        <!-- Boton para actualizar los datos -->
                                        <button type="submit" style="background: #d34836" class="btn btn-danger">Actualizar cuenta</button>                                 
                                    </form:form>                          
                                </div>
                            </div>
                        </div>
