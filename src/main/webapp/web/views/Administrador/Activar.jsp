...
<html class="no-js" lang="">
    ...
    <head>
        ...
        <title>Activar super administrador</title>
            ...
            <div class="container">
                <div class="login-content">
                    ...
                    <div class="login-form">
                        <!-- <form> -->
                        <form:form action="activarUsuario" method="post" modelAttribute="usuario">
                            <div class="form-group">
                                <label>Correo institucional</label>                            
                                <form:input path="correo" type="email" class="form-control" placeholder="anamarianagh@ufps.edu.co"/>                       

                            </div>
                            <div class="form-group">
                                <label>Código de activación</label>                            
                                <form:input id="codActivo" path="codActivo" class="form-control" placeholder="Ingrese el código de activación"/>     
                            </div>
                            <button id="activar" type="submit" style="background: #d34836" class="btn btn-danger btn-flat m-b-30 m-t-30">Activar</button>
                        </form:form>
                    </div>
                </div>
            </div>
