                        ...
                        <div class="page-header float-left">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="${contextPath}/redesSociales">Redes sociales</a></li>
                                    <li class="active"><a href="#">Eliminar red social</a></li>
                                </ol>
                            </div>
                        </div>    
                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form:form id="formRedSocial" action="borrarRedSocial" method="post" modelAttribute="redSocial" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="text-input" class=" form-control-label">¿Está seguro de eliminar la red social "${redSocial.nombre}"?</label>                                		
                                        </div> 
