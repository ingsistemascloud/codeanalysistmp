                        ...
                        <div class="page-header float-left">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active"><a href="#">Eliminar usuario</a></li>
                                </ol>
                            </div>
                        </div>    
                    </div>
                        ...
                        <div class="col-md-12">                	
                            ...
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <strong class="card-title">Eliminar usuario</strong>
                                </div>
                                <div class="card-body">
                                    ...
                                    <!-- Formulario -->
                                    <form:form id="formUsuario" action="borrarUsuario" method="post" modelAttribute="usuario">
                                        ...
                                        <div class="form-group">
                                            <label for="text-input" class=" form-control-label">¿Está seguro de eliminar el usuario con código ${usuario.codigo} y correo "${usuario.correo}"?</label>                                		
                                        </div> 
